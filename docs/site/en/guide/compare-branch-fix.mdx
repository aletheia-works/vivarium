...
<Page>
  ...
  >
    <p>Layer 2 (Docker catalogue) recipes can't run in a browser tab — the bug needs a real OS, real sockets, real filesystem. Path B shifts the build to your own infrastructure and uses a GitHub Actions workflow to capture the verdict against your pushed image.</p>
    <NumberedList
      items={[
        {
