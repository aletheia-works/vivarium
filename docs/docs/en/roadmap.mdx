...
<Page>
  ...
  <KpiStrip
    items={[
      { value: '14', label: 'Recipes shipped', accent: 'teal' },
  ...
  >
    ...
    <ul>
      <li>14 recipes shipped across the three layers, from browser-native WASM pages to Docker and record-replay snapshots.</li>
