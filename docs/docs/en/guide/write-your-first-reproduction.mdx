...
`}</code></pre>
    <p>Check that <code>docs/public/api/recipes.json</code> contains your slug. With the docs site running locally, the new recipe shows up as a card on the gallery:</p>
